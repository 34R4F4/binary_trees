...
{
	int left_balanced, right_balanced;
	size_t balancer, left_height, right_height;
	...
	left_balanced = bal_avl(tree->left, lower, tree->n);
	right_balanced = bal_avl(tree->right, tree->n, upper);
